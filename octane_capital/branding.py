...
def print_header():
    ...
    print(f"{OBSIDIAN}{'Research & Risk-Limited Trading System':^80}{Style.RESET_ALL}")
    print("=" * 80 + "\n")
...
def print_agent_status(agent_name: str, status: str, details: str = ""):
    ...
    print(f"{color}[{status:12}]{Style.RESET_ALL} {CHROME}{agent_name:<20}{Style.RESET_ALL}", end="")
    if details:
...
def print_footer():
    """Print the footer."""
    print(f"\n{CHROME}{'─' * 80}{Style.RESET_ALL}")
    print(f"{OBSIDIAN}{'Research mode — no live trading':^80}{Style.RESET_ALL}")
    print(f"{CHROME}{'─' * 80}{Style.RESET_ALL}\n")
