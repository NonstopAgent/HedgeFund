"""Octane Capital Lab - visual branding module.
...
def print_header():
    ...
    print(f"{OBSIDIAN}{'AI Research Engine':^80}{Style.RESET_ALL}")
    print("=" * 80 + "\n")
...
def print_agent_status(agent_name: str, status: str, details: str = ""):
    ...
    print(
        f"{color}[{status:8}]{Style.RESET_ALL} {CHROME}{agent_name:<20}{Style.RESET_ALL}",
        end="",
    )
    if details:
...
def print_footer():
    """Print the footer."""
    print(f"\n{CHROME}{'─' * 80}{Style.RESET_ALL}")
    print(f"{OBSIDIAN}{'Research complete — no trades executed':^80}{Style.RESET_ALL}")
    print(f"{CHROME}{'─' * 80}{Style.RESET_ALL}\n")
