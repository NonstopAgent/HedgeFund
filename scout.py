"""
Octane Global Trust - The Scout Agent (CrewAI)
...
from octane_branding import print_agent_status, print_ticker_card
import json
...
def create_scout_agent() -> Agent:
    ...
    scout = Agent(
        ...
        backstory="""You are The Scout, a specialized financial intelligence analyst at Octane Global Trust. 
